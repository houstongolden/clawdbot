...
// Package manifest for the Myo macOS companion (menu bar app + IPC library).
...
let package = Package(
    ...
    products: [
        ...
        .executable(name: "Myo", targets: ["OpenClaw"]),
        .executable(name: "myo-mac", targets: ["OpenClawMacCLI"]),
    ],
    dependencies: [
