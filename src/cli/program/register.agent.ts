...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['myo agents set-identity --agent main --name "Myo" --emoji "🧠"', "Set name + emoji."],
  ["myo agents set-identity --agent main --avatar avatars/myo.png", "Set avatar path."],
  [
    "myo agents set-identity --workspace ~/.myo/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "myo agents set-identity --identity-file ~/.myo/workspace/IDENTITY.md --agent main",
